...
## Active plan
Exactly one ExecPlan is ACTIVE at a time. Current: **EP-006 (ACTIVE)** —
EP-005 is DONE. Update this line when a plan completes; the next plan in
...
| EP | Status | | EP | Status |
|---|---|---|---|---|
| 000 | SKIPPED (greenfield) | | 006 | ACTIVE |
