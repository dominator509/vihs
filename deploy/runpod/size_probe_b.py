#!/usr/bin/env python3
"""Probe B: does a SMALL image from TTL.SH start fast on a cold node?
Isolates SIZE vs REGISTRY-PATH. Terminates pod in finally."""
...
code = 'print("PROBE_B_UP")'
b64 = base64.b64encode(code.encode()).decode()
args = f'python -c "import base64;exec(base64.b64decode(\'{b64}\'))"'

body = {
    "name": "vihs-size-probe-b",
    "image": "ttl.sh/vihs-size-probe2:24h",
