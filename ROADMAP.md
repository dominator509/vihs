...
| 3 API/service layer | Orchestrator: auth gateway, session API, signaling relay, router, pod registry, autoscaler w/ mock provider | 2 | Contract tests for all SPEC-003 routes green; autoscaler sim tests green | SPEC-003, SPEC-005 | EP-004 |
